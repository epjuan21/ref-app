...
export default function MedicamentCard({ medicament }) {
    ...
    return (
        <div className='border rounded border-indigo-200 mt-2 p-4'>

            <div className='flex flex-col md:flex-row justify-between border-b-slate-100 border-b pb-2'>
            ...
            <div className='flex justify-between flex-wrap'>
                ...
                <div className='w-28'>
                    <span className='text-xs font-medium text-gray-500'>Estado CUM</span>
                    <p className={`${estadocum == "Inactivo" ? "bg-rose-100 text-rose-900" : "bg-lime-100 text-lime-900"} font-semibold  rounded p-1 pl-2 text-sm`}>{estadocum}</p>
                </div>
